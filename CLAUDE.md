...
- **L'en-tête salue _et_ nomme le compte.** « Bon retour, &lt;Nom&gt; » sur une ligne, l'adresse sous elle. La salutation seule avait retiré la seule mention de quel compte est connecté, à côté du bouton de déconnexion — sur un appareil partagé, ou entre deux personnes portant le même prénom, plus rien ne disait quelles données ce bouton allait quitter. Sur sa propre ligne et non à la suite : un nom long tronquait l'adresse hors de l'écran sur un téléphone.
