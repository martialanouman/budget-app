                        ...
                        {stillRemovable(entry, now) ? (
                          <>
                            ...
                            <button
                              ...
                              className={`${SECONDARY_BUTTON_CLASS} aria-pressed:border-danger aria-pressed:text-danger`}
        ...
        {hasNextPage ? (
          <div ref={sentinelRef} className="pt-2">
            <button
              ...
              className={`${SECONDARY_BUTTON_CLASS} w-full bg-surface disabled:opacity-60`}
            >
